...
@asset
def jury_supabase(context: AssetExecutionContext, constitution_articles, ipc_sections_asset,bns_sections_asset: list) -> None:
    """Insert constitution articles, ipc_sections_asset,bns_sections_asset into Supabase with category UUID mapping."""
    if not constitution_articles + ipc_sections_asset:
        context.log.warning("No constitution_articles, ipc_sections_asset , bns_sections_asset to insert into Supabase.")
        return
    ...
    for section in constitution_articles, ipc_sections_asset , bns_sections_asset:
        try:
